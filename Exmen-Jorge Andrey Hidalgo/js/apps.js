...
infospot5.element.innerHTML = '<div style="background-color: rgba(0,0,0,0.8); color:#fff; border-radius: 5px; padding: 10px, font-size: 14px; width: 200px;"> Asientos VIP para mejor vista y calidad de servicio personalizado.</div> <img src="imagenes/VIP.jpg" alt="Cafetería local" style="width: 80%; border-radius: 5px; margin: 10px 0;">';
